 ...
 */
package com.camon.lagomhellostream.api;
 ...
 * consume the LagomhelloStreamService service.
 */
public interface LagomhelloStreamService extends Service {
  ...
  default Descriptor descriptor() {
    return named("lagomhello-stream")
        .withCalls(
