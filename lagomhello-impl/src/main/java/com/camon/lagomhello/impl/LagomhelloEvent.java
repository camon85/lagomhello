 ...
 */
public interface LagomhelloEvent extends Jsonable, AggregateEvent<LagomhelloEvent> {
   ...
   * events.
   */
  AggregateEventShards<LagomhelloEvent> TAG = AggregateEventTag.sharded(LagomhelloEvent.class, 4);
  ...
  @Override
  default AggregateEventTagger<LagomhelloEvent> aggregateTag() {
    return TAG;
  }
}
