...
public class LagomhelloEntityTest {

  static ActorSystem system;

  @BeforeClass
  public static void setup() {
    system = ActorSystem.create("LagomhelloEntityTest");
  }
  ...
  @Test
  public void testLagomhelloEntity() {
    PersistentEntityTestDriver<LagomhelloCommand, LagomhelloEvent, LagomhelloState> driver = new PersistentEntityTestDriver<>(system,
        new LagomhelloEntity(), "world-1");

    Outcome<LagomhelloEvent, LagomhelloState> outcome1 = driver.run(new Hello("Alice"));
    assertEquals("Hello, Alice!", outcome1.getReplies().get(0));
    assertEquals(Collections.emptyList(), outcome1.issues());

    Outcome<LagomhelloEvent, LagomhelloState> outcome2 = driver.run(new UseGreetingMessage("Hi"),
        new Hello("Bob"));
